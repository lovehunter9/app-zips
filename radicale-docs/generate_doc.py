"""
Generate Radicale 简易使用文档.docx from the companion Markdown file.

Reads:  Radicale简易使用文档.md (same directory)
Writes: Radicale简易使用文档.docx (same directory)
...
MD_PATH = os.path.join(HERE, 'Radicale简易使用文档.md')
DOCX_PATH = os.path.join(HERE, 'Radicale简易使用文档.docx')
